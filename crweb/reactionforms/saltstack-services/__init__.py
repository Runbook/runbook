...
class ReactForm(BaseReactForm):
  ...
  function = SelectField("Function", choices=function_choices,  validators=[DataRequired(message='Function is a required field')])
  ...
  args = TextField("Service", validators=[DataRequired(message='Service is a required field')])
