...
## Open Syslog
syslog.openlog(ident=sys.argv[0] + "-" + config['control_appname'], logoption=syslog.LOG_PID, facility=syslog.LOG_LOCAL0)
...
connaddress = "tcp://%s:%d" % ( config['broker_ip'], config['broker_control_port'] )
