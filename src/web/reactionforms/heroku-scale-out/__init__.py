...
class ReactForm(BaseReactForm):
    ...
    max_quantity = TextField("Maximum Dynos", validators=[DataRequired(message="Maximum Dyno is a required field"), NumberRange(min=1, max=None, message="Must be a number between 1 - 99999")])
