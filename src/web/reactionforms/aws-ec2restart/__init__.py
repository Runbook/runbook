...
class ReactForm(BaseReactForm):
    ...
    title = "AWS: Restart EC2 Instance"
    description = """
    This reaction gives you the ability to restart any Amazon Web Services instance. When invoked this reaction utilizes the AWS API to request the specified instance is restarted.
    """
