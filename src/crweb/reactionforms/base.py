...
class BaseReactForm(Form):
    ...
    trigger = IntegerField("Trigger", validators=[NumberRange(
        min=0, max=999, message='Trigger must be a number between 0 - 999')])
    frequency = IntegerField("Frequency", validators=[NumberRange(
        min=0, max=999999999, message='Frequency must be a number between 0 - 999999999')])
