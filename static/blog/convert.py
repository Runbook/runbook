...
for key in pids:
    ...
    if genPostPage(
        template, htmldata,
            config['output_dir'], config['template_dir']):
...
if genPage(
    "archive.html", template, htmldata,
        config['output_dir'], config['template_dir']):
...
if genPage(
    "index.xml", template, htmldata,
        config['output_dir'] + "/feed", config['template_dir']):
